...
public class AddUserModel {
	...
	public static void addUser(String usn, String pwd, String fn, String ln, String typ, String ema)
			throws ClassNotFoundException, SQLException {
		String combine = usn + pwd;
		String hashed = database.hash.sha1(combine);
		String addUserSQL = "insert into " + database.JDBConnect.tbl_user
				+ " values ((SELECT max(USER_ID)+1 FROM USERDET), '" + usn + "', '" + hashed + "', '" + fn + "', '" + ln
				+ "', '" + typ + "', '" + ema +"')";
