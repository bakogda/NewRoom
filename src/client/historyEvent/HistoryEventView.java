...
public class HistoryEventView extends JFrame {
	...
	public HistoryEventView() throws ClassNotFoundException
	{
		...
		try {
			...
			ResultSet resultSet = statement.executeQuery(
					"SELECT USER_ID, TITLE AS EVENT_TITLE, DATE, ROOM, STARTTIME AS STARTED_AT, ENDTIME AS FINISHED_AT, DESCR AS DESCRIPTION FROM EVENT WHERE DATE<'"
							+ date2 + "'AND USER_ID='" + userid + "'");
	...
	{
		HistoryEventView frame = new HistoryEventView();
