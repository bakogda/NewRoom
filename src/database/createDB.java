...
//	public static final String tbl_login = "login";
	...
	public static void userTable() throws ClassNotFoundException, SQLException{
		try {
			...
			Class.forName(dBV.DRIVER);
			Connection connection = DriverManager.getConnection(dBV.JDBC_URL);
			connection.createStatement().execute("create table " + tbl_user +" ( USERNAME varchar(32), PASSWORD varchar(50), FIRSTNAME varchar(50), LASTNAME varchar(50), USERTYPE varchar(20), PRIMARY KEY (USERNAME))");
			System.out.println(tbl_user + " table created");
			
			//insert dummy account info
			connection.createStatement().execute(
					"insert into " + tbl_user +" values " + 
					"('" + admin + "','"+ adminPass +"','John','Watt','admin')," + 
					"('" + user + "','"+ userPass +"','David','Blake','normal')");
...
//////////////////////////////////////////////////////////////////////////////////
	...
	public static void calendarTable() throws ClassNotFoundException, SQLException {
		...
		try {
			Class.forName(dBV.DRIVER);
			Connection connection = DriverManager.getConnection(dBV.JDBC_URL);
			connection.createStatement().execute("create table " + tbl_cal +" (C_ID INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1, INCREMENT BY 1), "
					+ "COWNER varchar(32), PRIMARY KEY(C_ID))");
...
//////////////////////////////////////////////////////////////////////////////////
	...
	public static void shareTable() throws ClassNotFoundException, SQLException{
		...
		try {
			Class.forName(dBV.DRIVER);
			Connection connection = DriverManager.getConnection(dBV.JDBC_URL);
			connection.createStatement().execute("create table " + tbl_share +" (S_ID INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1, INCREMENT BY 1), "
					+ "COWNERREF varchar(32), CREC varchar(32), PRIMARY KEY (S_ID))");
...
//////////////////////////////////////////////////////////////////////////////////
	...
	public static void eventTable() throws ClassNotFoundException, SQLException{
		...
		try {
			Class.forName(dBV.DRIVER);
			Connection connection = DriverManager.getConnection(dBV.JDBC_URL);
			connection.createStatement().execute("create table " + tbl_event +" (E_ID INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1, INCREMENT BY 1), "
					+ "TITLE varchar(50), "
					+ "DATE date,"
					+ "ROOM varchar(50), "
					+ "STARTTIME TIME, "
...
//////////////////////////////////////////////////////////////////////////////////
	...
	public static void inviteTable() throws ClassNotFoundException, SQLException{
		try {
			Class.forName(dBV.DRIVER);
			Connection connection = DriverManager.getConnection(dBV.JDBC_URL);
			connection.createStatement().execute("create table " + tbl_invite +" (I_ID INTEGER GENERATED ALWAYS AS IDENTITY(START WITH 1, INCREMENT BY 1), "
					+ "SERNER varchar(32), RECIEVER varchar(32), E_IDREF INTEGER, MESSAGE varchar(200), PRIMARY KEY (I_ID))");
